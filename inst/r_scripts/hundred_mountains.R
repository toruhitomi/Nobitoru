...
if (system.file("extdata", "list_100_mountains.csv", package = "Nobitoru") != "") {
  mt.df <- data.table::fread(system.file("extdata", "list_100_mountains.csv", package = "Nobitoru"))
} else {
  if (system.file("extdata", "hundred_mountains_of_Japan.xlsx", package = "Nobitoru") != "") {
